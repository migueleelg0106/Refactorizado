    ...
    public static class MensajeServidorHelper
    {
        ...
        private static readonly Dictionary<string, Func<string>> MapaMensajes =
            new Dictionary<string, Func<string>>(StringComparer.Ordinal)
            {
                ...
                ["Se requiere el nombre de usuario del remitente y del receptor."] = () => LangResources.Lang.errorTextoCamposInvalidosGenerico,
                ["No es posible enviarse una solicitud de amistad a sí mismo."] = () => LangResources.Lang.buscarAmigoErrorSolicitudMismoUsuario,
                ["No se encontró al remitente especificado."] = () => LangResources.Lang.errorTextoUsuarioNoEncontrado,
                ["No se encontró al receptor especificado."] = () => LangResources.Lang.errorTextoUsuarioNoEncontrado,
                ...
                ["No existe una solicitud de amistad pendiente entre los jugadores."] = () => LangResources.Lang.solicitudesErrorSolicitudNoPendiente,
                ["La solicitud de amistad ya fue atendida."] = () => LangResources.Lang.solicitudesErrorSolicitudAtendida,
                ["No fue posible procesar la respuesta a la solicitud de amistad."] = () => LangResources.Lang.solicitudesErrorProcesarRespuesta,
                ["Solicitud de amistad enviada correctamente."] = () => LangResources.Lang.buscarAmigoTextoSolicitudEnviada,
                ["Solicitud de amistad aceptada correctamente."] = () => LangResources.Lang.solicitudesTextoSolicitudAceptada,
                ["Solicitud de amistad rechazada."] = () => LangResources.Lang.solicitudesTextoSolicitudRechazada,

    ...
    public static class MensajeServidorHelper
    {
        ...
        private static readonly Dictionary<string, Func<string>> MapaMensajes =
            new Dictionary<string, Func<string>>(StringComparer.Ordinal)
            {
                ...
                ["Solicitud de amistad enviada correctamente."] = () => LangResources.Lang.avisoTextoSolicitudAmistadEnviada,
                ["Solicitud de amistad aceptada."] = () => LangResources.Lang.avisoTextoSolicitudAmistadAceptada,
                ["Solicitud de amistad rechazada."] = () => LangResources.Lang.avisoTextoSolicitudAmistadRechazada,
                ["No puedes enviarte una solicitud de amistad."] = () => LangResources.Lang.errorTextoAmistadAutoSolicitud,
                ["Los jugadores ya son amigos."] = () => LangResources.Lang.errorTextoAmistadYaSonAmigos,
                ["Ya enviaste una solicitud a este jugador."] = () => LangResources.Lang.errorTextoAmistadSolicitudDuplicada,
                ["Tienes una solicitud pendiente de este jugador."] = () => LangResources.Lang.errorTextoAmistadSolicitudPendiente,
                ["No se encontró alguno de los jugadores especificados."] = () => LangResources.Lang.errorTextoJugadoresNoEncontrados,
                ["La solicitud de amistad no existe."] = () => LangResources.Lang.errorTextoSolicitudAmistadNoExiste,
                ["No fue posible enviar la solicitud de amistad."] = () => LangResources.Lang.errorTextoAmistadEnviar,
                ["No fue posible actualizar la solicitud de amistad."] = () => LangResources.Lang.errorTextoAmistadActualizar,
                ["No puedes eliminarte como amigo."] = () => LangResources.Lang.errorTextoAmistadEliminarPropio,
                ["Los jugadores no tienen una amistad registrada."] = () => LangResources.Lang.errorTextoAmistadNoRegistrada,
                ["Amigo eliminado correctamente."] = () => LangResources.Lang.avisoTextoAmistadEliminada,
                ["No fue posible eliminar al amigo."] = () => LangResources.Lang.errorTextoAmistadEliminar,

    ...
    public class InicioSesionServicio : IInicioSesionServicio
    {
            ...
            DTOs.CredencialesInicioSesionDTO solicitud)
        {
            ...
            try
            {
                ...
                {
                    _logger.Warn("El servicio de inicio de sesi�n retorn� null.");
                    return null;
                }
                ...
                if (resultadoDto.Usuario != null)
                {
                    ...
                    _logger.Info("Usuario '{0}' inici� sesi�n" +
                        " exitosamente.", resultadoDto.Usuario.NombreUsuario);
                }
                else
                {
                    _logger.Warn("Inicio de sesi�n fallido: Credenciales incorrectas o cuenta no" +
                        " encontrada.");
                }
            ...
            {
                _logger.Warn("Error de l�gica en el servidor durante inicio de sesi�n.", ex);
            ...
            {
                _logger.Error("No se pudo conectar con el endpoint de inicio de sesi�n.", ex);
            ...
            {
                _logger.Error("Tiempo de espera agotado durante inicio de sesi�n.", ex);
                throw new ServicioExcepcion(
            ...
            {
                _logger.Error("Error de comunicaci�n WCF durante inicio de sesi�n.", ex);
                throw new ServicioExcepcion(
                    TipoErrorServicio.Comunicacion,
                    Lang.errorTextoServidorNoDisponible,
                    ex);
            ...
            {
                _logger.Error("Operaci�n inv�lida al iniciar sesi�n (Estado del cliente " +
                    "incorrecto).", ex);
                throw new ServicioExcepcion(

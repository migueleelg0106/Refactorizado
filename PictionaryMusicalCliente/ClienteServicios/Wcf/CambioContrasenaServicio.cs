...
{
    /// <summary>
    /// Provee servicios para el flujo de recuperacion y cambio de contrase�a.
    /// </summary>
    public class CambioContrasenaServicio : ICambioContrasenaServicio
    {
            ...
            string identificador)
        {
            ...
            {
                _logger.Info("C�digo de recuperaci�n solicitado para: {0}", identificador);
            }
            ...
            string tokenCodigo)
        {
            ...
            if (resultado != null && resultado.CodigoEnviado)
            {
                _logger.Info("Reenv�o de c�digo de recuperaci�n solicitado.");
            }
            ...
            string codigoIngresado)
        {
            ...
            {
                _logger.Info("C�digo de recuperaci�n confirmado.");
            }
        ...
        /// <summary>
        /// Establece la nueva contrase�a despues de haber verificado el codigo.
        /// </summary>
            ...
            string nuevaContrasena)
        {
            ...
            if (resultado != null && resultado.OperacionExitosa)
            {
                _logger.Info("Contrase�a actualizada mediante recuperaci�n.");
            }
            ...
            string mensajeFallaPredeterminado)
        {
            ...
            {
                _logger.Warn("Error de servidor en flujo de cambio de contrase�a: " +
            ...
            {
                _logger.Error("Endpoint no encontrado en flujo de cambio de contrase�a.", ex);
            ...
            {
                _logger.Error("Timeout en flujo de cambio de contrase�a.", ex);
                throw new ServicioExcepcion(
            ...
            {
                _logger.Error("Error de comunicaci�n en flujo de cambio de contrase�a.", ex);
                throw new ServicioExcepcion(
                    TipoErrorServicio.Comunicacion,
                    Lang.errorTextoServidorNoDisponible,
                    ex);
            ...
            {
                _logger.Error("Operaci�n inv�lida en flujo de cambio de contrase�a.", ex);
                throw new ServicioExcepcion(

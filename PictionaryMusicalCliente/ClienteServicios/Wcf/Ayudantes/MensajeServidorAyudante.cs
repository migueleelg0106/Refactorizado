    ...
    public static class MensajeServidorAyudante
    {
        ...
        private static readonly Dictionary<string, Func<string>> MapaMensajes =
            new Dictionary<string, Func<string>>(StringComparer.Ordinal)
            {
                ...
                ["Ya existe una solicitud o relación de amistad entre los usuarios."] = () => LangResources.Lang.amigosErrorRelacionExistente,
                ["Solo el receptor de la solicitud puede aceptarla."] = () => LangResources.Lang.amigosErrorSoloReceptorAcepta,
                ["La solicitud de amistad ya fue aceptada con anterioridad."] = () => LangResources.Lang.amigosErrorSolicitudYaAceptada,
                ["No existe una solicitud de amistad entre los usuarios."] = () => LangResources.Lang.amigosErrorSolicitudInexistente,
                ["No es posible eliminar una relación consigo mismo."] = () => LangResources.Lang.amigosErrorEliminarRelacionPropia,
                ["No existe una relación de amistad entre los usuarios."] = () => LangResources.Lang.amigosErrorRelacionInexistente,

...
namespace PictionaryMusicalCliente.ClienteServicios.Wcf
{
    ...
    public class PerfilServicio : IPerfilServicio
    {
        ...
        public async Task<DTOs.UsuarioDTO> ObtenerPerfilAsync(int usuarioId)
        {
            ...
            {
                _logger.Error("Error de comunicaci�n al obtener perfil.", ex);
                throw new ServicioExcepcion(
                    TipoErrorServicio.Comunicacion,
                    Lang.avisoTextoComunicacionServidorSesion,
                    ex);
            ...
            {
                _logger.Error("Operaci�n inv�lida al obtener perfil.", ex);
                throw new ServicioExcepcion(
            ...
            DTOs.ActualizacionPerfilDTO solicitud)
        {
            ...
            {
                _logger.Error("Error de comunicaci�n al actualizar perfil.", ex);
                throw new ServicioExcepcion(
                    TipoErrorServicio.Comunicacion,
                    Lang.errorTextoServidorNoDisponible,
                    ex);
            ...
            {
                _logger.Error("Operaci�n inv�lida al actualizar perfil.", ex);
                throw new ServicioExcepcion(
                    TipoErrorServicio.OperacionInvalida,

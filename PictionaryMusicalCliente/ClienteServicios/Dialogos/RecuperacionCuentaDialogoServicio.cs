...
namespace PictionaryMusicalCliente.ClienteServicios.Dialogos
{
    ...
    public class RecuperacionCuentaDialogoServicio : IRecuperacionCuentaServicio
    {
            ...
            ICambioContrasenaServicio cambioContrasenaServicio)
        {
            ...
            _logger.Info("Iniciando flujo de recuperaci�n de cuenta para: {0}", identificador);
            ...
            if (!solicitudExitosa)
            {
                _logger.Warn("Flujo detenido: No se pudo solicitar el c�digo. Mensaje: " +
            ...
            {
                _logger.Warn("Flujo detenido: Verificaci�n de c�digo fallida o cancelada.");
            ...
            string token, ICambioContrasenaServicio servicio)
        {
            ...
            {
                _logger.Info("Cambio de contrase�a completado exitosamente.");
            ...
            {
                _logger.Info("Di�logo de cambio de contrase�a cancelado.");
